...
export const en = {
  ...
  customContextIntro: 'Save context locally and send it to OpenAI with every ordinary Codex request. Do not include secrets. The plugin uses standard Responses input messages rather than an undocumented request field.',
  customContextValue: 'Context text',
  customContextPlaceholder: 'Add project, environment, or workflow context for Codex…',
  customContextKind: 'Trust level',
  customContextApplication: 'Application context (trusted)',
  customContextApplicationHint: 'Use only for context you author and trust. Codex receives it as a developer message.',
  customContextUntrusted: 'External context (untrusted)',
  customContextUntrustedHint: 'Use for copied, retrieved, or externally supplied content. Codex receives it as a user message.',
  customContextLength: '{count} / {limit} characters',
  customContextSave: 'Save context',
  customContextSettingsFailed: 'Custom context settings could not be saved.',
...
export const zh: { [Key in OpenAICodexSettingsKey]: string } = {
  ...
  customContextIntro: '上下文会保存在本机，并随每次普通 Codex 请求发送给 OpenAI，请勿填写秘密；插件使用标准 Responses 输入消息，不发送未公开的请求字段。',
  customContextValue: '上下文内容',
  customContextPlaceholder: '为 Codex 添加项目、环境或工作流上下文…',
  customContextKind: '信任级别',
  customContextApplication: '应用上下文（可信）',
  customContextApplicationHint: '仅用于你亲自编写并信任的上下文；Codex 会将其作为 developer 消息接收。',
  customContextUntrusted: '外部上下文（不可信）',
  customContextUntrustedHint: '用于复制、检索或外部提供的内容；Codex 会将其作为 user 消息接收。',
  customContextLength: '{count} / {limit} 字符',
  customContextSave: '保存上下文',
  customContextSettingsFailed: '无法保存自定义上下文设置。',
  imageTools: '图片工具',
