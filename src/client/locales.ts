...
export const en = {
  ...
  noSession: "Open a conversation before managing OpenAI Codex.",
  checkingRuntime: "Checking the connected runtime…",
  notInstalled: "OpenAI Codex is not installed in {runtime}.",
  runtimeUnavailable:
    "The connected runtime could not report OpenAI Codex status: {message}",
...
export const zh: { [Key in OpenAICodexSettingsKey]: string } = {
  ...
  noSession: "请先打开一个会话，再管理 OpenAI Codex。",
  checkingRuntime: "正在检查当前运行环境…",
  notInstalled: "{runtime} 未安装 OpenAI Codex。",
  runtimeUnavailable: "无法读取当前运行环境的 OpenAI Codex 状态：{message}",
