...
export const en = {
  ...
  proxy: 'Network proxy',
  proxyHint: 'Routes all OpenAI Codex traffic, including login, through this HTTP(S) proxy. Applies immediately after saving; leave empty to fall back to environment variables.',
  proxySave: 'Save',
...
export const zh: { [Key in OpenAICodexSettingsKey]: string } = {
  ...
  proxy: '网络代理',
  proxyHint: '所有 OpenAI Codex 流量（含登录）都经该 HTTP(S) 代理转发，保存后立即生效；留空则回退到环境变量。',
  proxySave: '保存',
